/****************************************************************************
** Meta object code from reading C++ file 'cpu_softirq_model.h'
**
...
#include "../../../../display_monitor/cpu_softirq_model.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#include <QtCore/QVector>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'cpu_softirq_model.h' doesn't include <QObject>."
...
void monitor::MonitorBaseModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        MonitorBaseModel *_t = static_cast<MonitorBaseModel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (MonitorBaseModel::*_t)(const QModelIndex & , const QModelIndex & , const QVector<int> & );
...
const QMetaObject monitor::MonitorBaseModel::staticMetaObject = {
    { &MonitorInterModel::staticMetaObject, qt_meta_stringdata_monitor__MonitorBaseModel.data,
      qt_meta_data_monitor__MonitorBaseModel,  qt_static_metacall, nullptr, nullptr}
};
